        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Pemasukan</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                             <th>No.</th><th width="17%">Tanggal</th><th>Jumlah Uang</th><th width="14%"><center>Penerima<th>Keterangan</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/print_satu.php?id=<?= $data['id_pemasukan'] ?>" target="_blank" class="btn btn-info btn-xs">
