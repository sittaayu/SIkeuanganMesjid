<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM pemasukan WHERE id_pemasukan='$id'") or die ("SQL Edit error");
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="nope" class="col-sm-3 control-label">Jumlah Pengeluaran</label>
                             <div class="col-sm-9">
                                <input type="text" name="jml_pengeluaran" value="<?=$data['jml_uang']?>"class="form-control" id="inputEmail3" placeholder="Jumlah Pengeluaran" readonly="true">
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE pemasukan SET  tanggal='$tgl_pengeluaran', jml_uang='$jml_pengeluaran',
    penerima='$penangjawab', keterangan='$ket' WHERE id_pemasukan='$id'"; 
