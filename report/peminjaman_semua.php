...
<html>
    <head>
        <title>Cetak Data Semua Pengeluaran</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SELURUH PENGELUARAN MASJID</h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                                <thead>
								<tr>
									<th>No.</th><th width="18%">Jumlah Pengeluaran</th><th>Tanggal Pengeluaran</th><th>Keterangan</th><th>Penanggung Jawab</th>
								</tr>
								</thead>
							<tbody>
